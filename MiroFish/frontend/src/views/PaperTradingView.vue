  ...
  <div class="paper-trading">
    ...
    <header class="header">
      <div class="header-left">
        <h1>Paper Trading <span class="help-icon" @click.stop="showInfo = true">ⓘ</span></h1>
    ...
    <teleport to="body">
      <div v-if="showInfo" class="modal-overlay" @click.self="showInfo = false">
        <div class="modal-content">
          ...
          <p style="font-size:13px;color:#888;margin-top:-8px">For the full engine deep-dive, see <a href="/how-it-works" style="color:#FF4500;text-decoration:underline" @click="showInfo = false">How PolFish Thinks</a></p>
