            ...
            if simulation_id:
                ...
                return jsonify({
                    ...
                    "data": {
                        ...
                        "status": "not_started",
                        "progress": 0,
                        "message": "Preparation not started, please call /api/simulation/prepare",
                        "already_prepared": False
                    }
                })
            return jsonify({
    ...
    try:
        ...
        if enable_graph_memory_update:
            ...
            if not graph_id:
                return jsonify({
                    "success": False,
                    "error": "Enabling graph memory update requires a valid graph_id, please ensure graph has been built"
                }), 400
...
def get_env_status():
    ...
    try:
        ...
        if env_alive:
            message = "Environment is running, ready to accept interview commands"
        else:
